        ...
        <div class="room-page">
          ...
          <div class="room-gallery">
            ...
            <div class="room-image-list" >
                <img v-for="imageUrl in roomDetails.imageUrlList"
                :src="imageUrl"
          ...
          <div class="room-info">
            <div class="info-block">
              ...
              <p>價格: NT${{ roomDetails.price }}</p>
            </div>

            <div class="info-block">
              <h2>房間配置</h2>
              <ul>
                <li v-for="info in roomDetails.layoutInfo">
                  {{ info.title }}: {{ info.isProvide ? "提供" : "不提供" }}
                </li>
              </ul>
            </div>
            ...
            <div class="info-block">
              <h2>房內設施</h2>
              <ul>
                <li v-for="info in roomDetails.facilityInfo">
                  {{ info.title }}: {{ info.isProvide ? "提供" : "不提供" }}
                </li>
              </ul>
            </div>
            ...
            <div class="info-block">
              <h2>客房備品</h2>
              <ul>
                <li v-for="info in roomDetails.amenityInfo">
                  {{ info.title }}: {{ info.isProvide ? "提供" : "不提供" }}
                </li>
              </ul>
            </div>
